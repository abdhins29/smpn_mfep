...
<div class="container-fluid">
	<div class="card shadow mb-4">
		<div class="card-header py-3">
			<h6 class="m-0 font-weight-bold text-primary">Laporan Data Keputusan Diterima</h6>
		</div>
		<div class="card-body">
			<div class="form-group">
				<form action="cetakterima.php" method="get">
	...
	<div class="card shadow mb-4">
		<div class="card-header py-3">
			<h6 class="m-0 font-weight-bold text-primary">Laporan Data Keputusan Tidak Diterima</h6>
		</div>
		<div class="card-body">
			<div class="form-group">
				<form action="cetaktolak.php" method="get">
					<input type="text" name="kepala_sekolah" placeholder="Masukan Nama Kepsek">
					<button type="submit" name="cetak" class="btn btn-md btn-primary"><i class="fas fa-md fa-print"> Cetak Laporan</i></button>
				</form>
			</div>
			<div class="table-responsive">
				<table class="table table-bordered">
					...
					while ($data = mysqli_fetch_array($sql)){
						$sql4=mysqli_query($konek,"SELECT * FROM tbl_crips WHERE nm_crips = '$data[prestasi]'");
